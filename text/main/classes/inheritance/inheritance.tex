...
We create the instance \pythonil{circ} of \pythonil{Circle} by providing the \pythonil{point=Point(2, 3)} and \pythonil{radius=5}.
...
The area computation is implemented using the formula~$A=\tfrac{1}{2}\left(x_1(y_2-y_3)+x_2(y_3-y_1)+x_3(y_1-y_2)\right)$ that you may remember from school maths.
