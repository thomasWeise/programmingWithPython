...
Its initializer \pythonilIdx{\_\_init\_\_}\pythonIdx{dunder!\_\_init\_\_}, we supply two parameters, \pythonil{center}, which is an instance of our class \pythonil{Point} from \cref{lst:classes:point}, and \pythonil{radius}, which can either be an \pythonil{int} or a \pythonil{float}.
...
In the initializer \pythonilIdx{\_\_init\_\_}\pythonIdx{dunder!\_\_init\_\_} of the class \pythonil{Rectangle}, we pass in two points~\pythonil{p1} and~\pythonil{p2}.
