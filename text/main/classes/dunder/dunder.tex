...
\pythonIdx{dunder}Dunder methods have names that begin and end with two underscores, like~\dunder{init}.
And indeed, \dunder{init}~is a dunder method, the initializer that creates the attributes of an object.
...
\gitPython{\programmingWithPythonCodeRepo}{09_dunder/xml_context.py}{--args format --labels part_1}{dunder:xml_context:part_1}{%
Part~1 of our very simply context manager-based \pgls{XML} output API.}%
%
\gitPython{\programmingWithPythonCodeRepo}{09_dunder/xml_context.py}{--args format --labels part_2}{dunder:xml_context:part_2}{%
...
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{09_dunder}{xml_user_print.py}{--args format}{dunder:xml_user_print}{%
...
%
\gitPythonAndOutputFormat{xml_style}%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{09_dunder}{xml_user_file.py}{--args format}{dunder:xml_user_file}{%
