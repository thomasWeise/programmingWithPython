...
%
\item \url{ssh://git@github.com/user/repository} (or \url{ssh://git@github.com/user/repository.git}) use SSH protocol to access the repository \textil{repository} of user \textil{user}. %
