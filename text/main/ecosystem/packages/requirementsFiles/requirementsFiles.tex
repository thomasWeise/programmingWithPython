...
A requirements file demanding that version~\textil{2.5.2} of \numpy\ be installed.}%
%
...
This tells \pip\ to install \emph{all} the requirements from the requirements file \programUrl{packages:requirementstxt}.
