...
They can contain each element at most once.
...
However, the order in which the elements are stored in a set is not always clear, so they may appear in a strange or unexpected order in the list or tuple.
