...
Such attacks can be prevented if the queries to \pglspl{db} are never dynamically constructed by the likes of \pglspl{fstring} but instead are always defined as string literals.
\python\ supports the type~\pythonilIdx{LiteralString} for string literals~\cite{PEP675}.
