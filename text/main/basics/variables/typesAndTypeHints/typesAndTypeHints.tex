...
\listingPythonAndOutput{variables:types}{variable_types.py}{%
...
\listingPythonAndOutput{variables:types_wrong}{variable_types_wrong.py}{%
...
\listingPythonAndOutput{variables:types_wrong_hints_1}{variable_types_wrong_hints_1.py}{%
...
\listingPythonAndOutput{variables:types_wrong_hints_2}{variable_types_wrong_hints_2.py}{%
