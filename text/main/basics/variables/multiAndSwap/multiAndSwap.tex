...
The first line~\pythonil{a, b = 5, 10}\pythonIdx{=!multiple}\pythonIdx{,} program \programUrl{variables:multi_and_swap} given as \cref{lst:variables:multi_and_swap} is equivalent to the two lines~\pythonil{a = 5} and~\pythonil{b = 10}.
