...
Fractional division, however, returns \pythonil{float} values, which we will explore in the next section (\cref{sec:floats}) in detail.
...
The remainder of this operation can be computed using the modulo operator \expandafter\pythonil{\%}, i.e., by typing \pythonil{33 \% 4}, which yields \pythonil{1}.
