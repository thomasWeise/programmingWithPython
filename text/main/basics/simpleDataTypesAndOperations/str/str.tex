...
\end{figure}%
%
\pythonIdx{str!f}\pythonIdx{f-string}Let us now discuss, preliminary, a very powerful gadget in \python's string processing toolbox: format strings, or f\nobreakdash-strings\pythonIdx{f-string}\pythonIdx{str!f} for short~\cite{PSF2024FSL,S2016P4LSI,M2017WAFSIPAHCIUT,B2023PFS}.
...
This process is called \emph{interpolation}\pythonIdx{f-string!interpolation}\pythonIdx{str!interpolation}.
...
We can also have multi-line f-strings\pythonIdx{str!f}\pythonIdx{f-string!multi-line}.
