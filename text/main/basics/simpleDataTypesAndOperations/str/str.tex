...
\end{figure}%
%
\pythonIdx{str!f}\pythonIdx{f-string}Let us now discuss, preliminary, a very powerful gadget in \python's string processing toolbox: format strings, or \pglspl{fstring}\pythonIdx{f-string}\pythonIdx{str!f} for short~\cite{PSF2024FSL,S2016P4LSI,M2017WAFSIPAHCIUT,B2023PFS}.
...
The user cannot interprete the binary representation of such data, they only want text.
