...
By the way, the empty string~\pythonilIdx{""}\pythonIdx{str!empty} has length~\pythonil{0}, i.e., \pythonilIdx{len("")} yields~\pythonil{0}.
...
\bestPractice{longstrDoubleQuote}{When defining a multi-line string literal, the double-quotation mark variant~(\pythonil{"""..."""})\pythonIdx{\textquotedbl\textquotedbl\textquotedbl} is usually preferred over the single-quotation mark variant~(\pythonil{'''...'''}\pythonIdx{\textquotesingle\textquotesingle\textquotesingle})~\cite{PEP257,PEP8}.}
