...
\item \pythonilIdx{float}: the floating point numbers, i.e., a subset of the real numbers~\realNumbers,%
\item \pythonilIdx{bool}: Boolean values, which can be either \pythonilIdx{True} or \pythonilIdx{False}, and%
\item \pythonilIdx{str}: strings, i.e., portions of text of arbitrary length.%
