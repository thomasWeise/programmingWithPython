...
\listingPythonAndOutput{exceptions:try_except_str_index}{try_except_str_index.py}{%
...
\listingPythonAndOutput{exceptions:try_except_nested_2}{try_except_nested_2.py}{%
...
\listingPythonAndOutput{exceptions:try_except_else}{try_except_else.py}{%
...
\listingPythonAndOutput{exceptions:file_try_finally}{file_try_finally.py}{%
...
\listingPythonAndOutput{exceptions:file_with}{file_with.py}{%
