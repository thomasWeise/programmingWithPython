...
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{functions}{def_factorial.py}{--args format}{functions:def_factorial}{%
...
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{functions}{def_gcd.py}{--args format}{functions:def_gcd}{%
...
%
\gitPython{\programmingWithPythonCodeRepo}{functions/my_math.py}{--args format}{functions:my_math}{%
...
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{functions}{use_my_math.py}{--args format}{functions:use_my_math}{%
...
Others are installed via a package manager like \pgls{pip}~\cite{PSF:P3D:IPM} (we will eventually discuss this later).
...
\glslink{unitTest}{\emph{Unit Testing}} is a software testing technique where separate components or functions of an application are tested in isolation.
\end{definition}%
%
...
If test cases are preserved and re-tested every time the software changes, then we can discover if a change that we applied to an older piece of code breaks a \pgls{unitTest}, i.e., may lead to an unwanted change of behavior our program that we did not anticipate.
...
\gitPython{\programmingWithPythonCodeRepo}{functions/test_my_math.py}{--args format}{functions:test_my_math}{%
A small \pgls{unitTest} suite for \cref{lst:functions:my_math}.}%
%
\gitOutputTool{\programmingWithPythonCodeRepo}{.}{_scripts_/pytest.sh functions test_my_math.py}{functions:test_my_math:pytest}{%
...
%
\FloatBarrier%
\gitPython{\programmingWithPythonCodeRepo}{functions/my_math_2.py}{--args format}{functions:my_math_2}{%
...
%
\gitPython{\programmingWithPythonCodeRepo}{functions/test_my_math_2.py}{--args format}{functions:test_my_math_2}{%
...
%
\gitOutputTool{\programmingWithPythonCodeRepo}{.}{_scripts_/pytest.sh functions test_my_math_2.py}{functions:test_my_math_2:pytest}{%
...
\end{sloppypar}%
%
\gitPython{\programmingWithPythonCodeRepo}{functions/my_math_3.py}{--args format}{functions:my_math_3}{%
...
%
\gitPython{\programmingWithPythonCodeRepo}{functions/test_my_math_3.py}{--args format}{functions:test_my_math_3}{%
...
%
\gitOutputTool{\programmingWithPythonCodeRepo}{.}{_scripts_/pytest.sh functions test_my_math_3.py}{functions:test_my_math_3:pytest}{%
...
A good \pgls{unitTest} for a given function should cover both expected as well as extreme cases. %
...
A good \pgls{unitTest} for a function should cover all branches of the control flow inside the function. %
...
%
\gitPython{\programmingWithPythonCodeRepo}{functions/normal_pdf.py}{--args format}{functions:normal_pdf}{%
...
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{functions}{use_normal_pdf.py}{--args format}{functions:use_normal_pdf}{%
Using the PDF of the normal distribution implemented in \cref{lst:functions:normal_pdf}.}%
%
After the brief introduction into \pglspl{unitTest}, let us now come to a lighter topic: passing arguments to functions.%
...
\end{figure}%
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{functions}{integral.py}{--args format}{functions:integral}{%
...
\gitOutputTool{\programmingWithPythonCodeRepo}{.}{_scripts_/mypy.sh functions integral.py}{functions:integral:mypy}{%
