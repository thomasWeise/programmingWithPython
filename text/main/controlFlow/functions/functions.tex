...
If we had placed the \programUrl{functions:my_math} file into a sub-directory named \textil{math_pack} instead, then we would import our functions from \textil{math_pack.my_math} instead, where \textil{math_pack} would be called a~\emph{package}.
...
Since \pythonil{nan != nan} is \pythonil{True}, the loop never ends~\cite{G1991WECSSKAFPA}.%
\end{sloppypar}%
%
