...
%
We can create a list by writing it down as a \pgls{literal}, e.g., \pythonil{[1, 2, 3, 4, 5]} creates a list\pythonIdx{list} containing the first five natural numbers.
