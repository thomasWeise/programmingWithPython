...
\listingPythonAndOutput{iteration:simple_list_comprehension}{simple_list_comprehension.py}{%
...
\listingPythonAndOutput{iteration:list_of_numbers_append}{list_of_numbers_append.py}{%
...
\listingPythonAndOutput{iteration:list_of_numbers_comprehension}{list_of_numbers_comprehension.py}{%
...
\usefulTool{doctest}{%
A \pgls{doctest} is a \pgls{unitTest} written directly into the \pgls{docstring} of a function or module. %
...
The \pglspl{doctest} can be by modules like \pythonilIdx{doctest}~\cite{PSF:P3D:TPSL:DTIPE} or tools such as \pytest~\cite{KPDT2024PD:HTRD}~(\cref{ut:pytest}). %
...
\listingPythonAndOutput{iteration:simple_set_comprehension}{simple_set_comprehension.py}{%
...
\listingPythonAndOutput{iteration:simple_dict_comprehension}{simple_dict_comprehension.py}{%
...
\listingPythonAndOutput{iteration:generator_expressions_next_1}{generator_expressions_next_1.py}{%
...
\listingPythonAndOutput{iteration:generator_expressions_in_reduction}{generator_expressions_in_reduction.py}{%
...
\listingPythonAndOutput{iteration:generator_expressions_loops}{generator_expressions_loops.py}{%
...
\listingPythonAndOutput{iteration:generator_expressions_to_collection}{generator_expressions_to_collection.py}{%
...
\listingPythonAndOutput{iteration:simple_generator_function_2}{simple_generator_function_2.py}{%
...
\listingPythonAndOutput{iteration:filter_takewhile}{filter_takewhile.py}{%
...
\listingPythonAndOutput{iteration:map}{map.py}{%
