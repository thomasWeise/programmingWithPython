...
The \pythonilIdx{for} loop constructing the list \textil{squares_1} can indeed by replaced by a list comprehension.}%
%
\begin{sloppypar}%
...
The final \pgls{doctst} symbolizes this as follows:
