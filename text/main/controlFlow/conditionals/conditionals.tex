...
\listingPythonAndOutput{conditionals:if}{if_example.py}{%
...
\listingPythonAndOutput{conditionals:if_else}{if_else_example.py}{%
...
\listingPythonAndOutput{conditionals:if_else_nested}{if_else_nested.py}{%
...
\listingPythonAndOutput{conditionals:if_elif}{if_elif_example.py}{%
...
\listingPythonAndOutput{conditionals:if_elif_nested}{if_elif_nested.py}{%
...
\listingPythonAndOutput{conditionals:if_else_could_be_inline}{if_else_could_be_inline.py}{%
...
\listingPythonAndOutput{conditionals:inline_if_else}{inline_if_else.py}{%
