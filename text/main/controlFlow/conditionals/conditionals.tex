...
Program \programUrl{conditionals:if} in \cref{lst:conditionals:if} implements this rule.
...
In \cref{lst:conditionals:if_else} we show exactly this functionality with program \programUrl{conditionals:if_else}.
