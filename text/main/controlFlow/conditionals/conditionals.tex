...
Yes, we can, and we explore this in our program \textil{if_else_nested.py} given in \cref{lst:conditionals:if_else_nested}.
...
The syntax of a combined \pythonil{if ... elif} is quite easy:
...
We now apply \ruff\ to our program \textil{if_else_nested.py} given \cref{lst:conditionals:if_else_nested}.
