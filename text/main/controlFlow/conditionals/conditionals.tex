...
%
\FloatBarrier%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{if_example.py}{--args format}{conditionals:if}{%
...
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{if_else_example.py}{--args format}{conditionals:if_else}{%
An example of using the \pythonil{if ... else}\pythonIdx{if{\idxdots}else} statement.}%
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{if_else_nested.py}{--args format}{conditionals:if_else_nested}{%
...
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{if_elif_example.py}{--args format}{conditionals:if_elif}{%
An example of using the \pythonil{if ... elif}\pythonIdx{if{\idxdots}elif{\idxdots}else} statement.}%
%
\gitOutputTool{\programmingWithPythonCodeRepo}{.}{_scripts_/ruff.sh conditionals if_else_nested.py}{conditionals:if_else_nested:ruff}{%
The results of linting with \ruff\ of the program given in \cref{lst:conditionals:if_else_nested}.}%
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{if_elif_nested.py}{--args format}{conditionals:if_elif_nested}{%
...
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{if_else_could_be_inline.py}{--args format}{conditionals:if_else_could_be_inline}{%
...
%
\gitOutputTool{\programmingWithPythonCodeRepo}{.}{_scripts_/ruff.sh conditionals if_else_could_be_inline.py}{conditionals:if_else_could_be_inline:ruff}{%
The results of linting with \ruff\ of the program given in \cref{lst:conditionals:if_else_could_be_inline}.}%
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{conditionals}{inline_if_else.py}{--args format}{conditionals:inline_if_else}{%
