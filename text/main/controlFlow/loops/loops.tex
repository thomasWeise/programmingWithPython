...
\listingPythonAndOutput{loops:for_loop_range}{for_loop_range.py}{%
...
\listingPythonAndOutput{loops:for_loop_continue_break}{for_loop_continue_break.py}{%
...
\listingPythonAndOutput{loops:for_loop_nested_primes}{for_loop_nested_primes.py}{%
...
\listingPythonAndOutput{loops:for_loop_sequence}{for_loop_sequence.py}{%
...
\listingPythonAndOutput{loops:for_loop_sequence_primes}{for_loop_sequence_primes.py}{%
Computing a list of all primes from \intRange{2}{200} using nested \pythonilIdx{for} loops. %
...
\listingPythonAndOutput{loops:for_loop_no_enumerate}{for_loop_no_enumerate.py}{%
...
\listingPythonAndOutput{loops:for_loop_enumerate}{for_loop_enumerate.py}{%
...
\listingPythonAndOutput{loops:while_loop_sqrt}{while_loop_sqrt.py}{%
...
\listingPythonAndOutput{loops:while_loop_search}{while_loop_search.py}{%
