...
In the original program \textil{pi_liu_hui.py}, we executed the same code five times.
...
This reduces the lines of code from over~25 to about~10 in program \textil{for_loop_pi_liu_hui.py} given in \cref{lst:loops:for_loop_pi_liu_hui}.
...
\endhsection%
%
\hsection{Enumerating over Sequences when needing Indices~(and Pylint)}%
