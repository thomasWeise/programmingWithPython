...
\endhsection%
%
\hsection{Loops over Sequences and Collections}%
%
\gitPythonAndOutput{\programmingWithPythonCodeRepo}{04_loops}{for_loop_sequence.py}{--args format}{loops:for_loop_sequence}{%
An example iterating over the elements in different container datastructures using \pythonilIdx{for} loops\pythonIdx{loop!for}.}%
%
...
Let us now use this new ability to iterate over container datastructures to improve upon our prime number enumeration program \cref{lst:loops:for_loop_nested_primes}.
